...
const ConfigSchema = z.object({
  ...
  WEBSOCKET_HEARTBEAT: z.coerce.number().default(30000),
  MAX_CONCURRENT_CONNECTIONS: z.coerce.number().default(100),
  MAX_CONCURRENT_ANALYSES: z.coerce.number().default(10),

  // Cognitive Processing Configuration
  COGNITIVE_PROCESSING_TIMEOUT: z.coerce.number().default(300000), // 5 minutes
  ML_SERVICE_URL: z.string().optional(),

  // Verification Threshold
  VERIFICATION_THRESHOLD: z.coerce.number().default(0.95),
